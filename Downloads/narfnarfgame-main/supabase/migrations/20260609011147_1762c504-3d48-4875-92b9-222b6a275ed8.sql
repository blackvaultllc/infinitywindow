...
-- Lock economy columns: only admins can change coins / bonus_multiplier / banned
...
-- Auto-create profile + auto-promote owner email to admin on signup
...
-- Backfill: if owner email already exists, promote
INSERT INTO public.profiles (id, email, display_name)
